...
export class MemberNotificationsGateway
  implements OnGatewayConnection, OnGatewayDisconnect, OnGatewayInit
{
  private readonly logger = new Logger(MemberNotificationsGateway.name);

  constructor(
    private readonly connections: MemberNotificationsConnectionService,
  ...
  afterInit() {
    this.events.register((userId, notification) => {
