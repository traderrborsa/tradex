        ...
        {portfolioLoading ? (
          ...
          <>
            <div className="mb-5 rounded-2xl bg-card p-5 shadow-sm sm:p-6">
              <p className="text-sm text-muted">Toplam varlık</p>
              ...
              {portfolio.positions.length > 0 && (
                ...
                >
                  {unrealizedTotal >= 0 ? '+' : ''}
                  {formatMoney(unrealizedTotal)} bugün
                </p>
              )}
              <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:gap-2">
                <Link href="/portfolio/deposit" className="corp-btn flex-1 py-3 text-center text-sm sm:flex-none">
                  Para yatır
                </Link>
                <Link href="/portfolio/withdraw" className="corp-btn-outline flex-1 py-3 text-center text-sm sm:flex-none">
                  Para çek
                </Link>
                <Link href="/portfolio/credit" className="corp-btn-outline flex-1 py-3 text-center text-sm sm:flex-none">
                  Kredi talebi
                </Link>
                <Link href="/portfolio/bonus" className="corp-btn-outline flex-1 py-3 text-center text-sm sm:flex-none">
                  Bonuslarım
                </Link>
              </div>
            </div>
            ...
            <div className="mb-6 grid grid-cols-2 gap-3">
              <div className={`${CARD} p-4`}>
                <p className="text-xs font-medium text-muted">Nakit</p>
